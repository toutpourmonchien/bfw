 ...
 *
 */
$drupal_hash_salt = 'Fdi4WQiesKIIh14nmwbLgPMdSHrCUPt7BxaELn7Hs84';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_bfw_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_bfw_dd.inc';
}
// </DDSETTINGS>
